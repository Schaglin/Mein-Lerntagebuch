...
Beispiele für selektive Schnittstellen gibt SRU (Google), Open search (Amazon),Solr API (Suchmaschine zusammen mit Vufind haben wir die ja installiert).
...
Control c und q=quit konnte ich wieder rausgehen. Less= Programm.
