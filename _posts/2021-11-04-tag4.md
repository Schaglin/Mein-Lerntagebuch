...
Es war praktisch, dass einem Archive Space direkt anzeigte, was noch fehlte und man 
so ein Dossier anlegen konnte.
...
und schaue es wie es im 8081 aussieht, leider sehe ich das Archival Object nicht mehr...ich sehe nur den Bestand und die Collection dazu....?
...
Es wird in xml geschreiben oder DTD.
...
**Lösung:** In der Lösung kam dann raus, dass die University eben viel detaillierter erschlossen hat mit Inventar und allem. Das Archive Space hat aber nicht so detailliert erschlossen. Archive Space hat z. b. auch das Jahr nicht richtig erschlossen dort steht von 1939- 1958 aber auf der Universitätssteite steht von 1939 - 1969 und der Bestand wird viel kleiner als die University erschlossen hat.
Die EAD- Datei hat z.b. nur eine REsource und keine Archival OBjects erschlossen. die HTML- Ansicht von der University zeigt aber ein inventar auf:
...
Es gab noch eine Frage zu den MARc Feldern 650..590...diese hat man in Archive Space übernommen, aber nicht korrekt, hier noch der Nachtrag dazu:
Nachtrag zu MARC-Feldern in EAD

    Ihnen war aufgefallen, dass das zum Import verwendete EAD-Beispiel in den Attributen encodinganalog stellenweise MARC-Feld-Codes enthält.
