...
DSpace haben wir ja die Metadaten abgespeichert als Downloads auf den virtuellen Maschinen, weil diese ja sonst von DSpace  gelöscht werden, weil nur Demoversion war. DSpace kann man daher nicht mit vufind harvest ernten, sondern wir haben eben copy+paste manuell von Browser in Textdatei gemacht. Das was rausgekommen ist, sind Dublin Core Daten in xml format.
Hier meine Metadaten aus DSpace, die wurden im gemeinsamen Dokument eingefügt:
...
Von Dublin Core zu Marc 21 geht daher nicht gut. In Dublin Core Namenfeld und marc 21 würde dann Familienname und Vorname und so ändern, dann müsste man jedes Mal entscheiden.
Erfahrung von Dozenten: man findet zwar fertige Crosswalks, aber man muss Daten anschauen und prüfen.
...
das war mein Eintrag im Archive Space zu Albert Hoffmann, es hat alle Felder genommen, weil von EAD in Marc21 geändert habe.
