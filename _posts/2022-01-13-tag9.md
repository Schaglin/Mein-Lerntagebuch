...
Swisscollections vielleicht besser bedient als mit Swisscovery für digitale.Swisscollections hat auch VuFind für Suche drin! Was noch erweitert wurde von der Unibibliothek. Demnach auch mit einem Solar Index im Hintergrund.
...
**Praxisprojekt: Deutsche Literaturarchiv in Marbach**
...
Die Software kommt für alle 3 Bereiche im gleichen Software von [Adis](https://de.wikipedia.org/wiki/ADIS/BMS). 
-**Bibliotheksmodul
-Archivmodul
-Museumsmodul**
...
$ wget https://github.com/OpenRefine/OpenRefine/releases/download/3.5.0/openrefine-linux-3.5.0.tar.gz
 ‘openrefine-linux-3.5.0.tar.gz.1’ saved [131840764/131840764]

 cd ~/openrefine-3.5.0
~/openrefine-3.5.0$ ./refine
...
Wir haben im Unterricht noch **Schiller** als Beispiel im wikidata genommen.
Interessant zu erfahren ist, dass man auch seine Einflüsse, seine Signatur (Unterschrift) sehen kann, die Identifier zum Teil sogar dem Japanischen Wikipedia stammen. Das Foto könnte man jetzt nehmen, weil es keine Urheberrechte darauf gibt. (für Katalog DLA Marbach haben sie dies genommen).
