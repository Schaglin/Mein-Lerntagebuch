...
Im wiki  kann mit isbn 10 auf isbn 13 kann das mit copy paste einfach anwednden
...
value.split(",")[0]
Value. S plit («,»)   ()= Funktion  ,aber Eckige Klammer beginnt bei 0, wollen aus dem Ergebnis nur ersten Teil
